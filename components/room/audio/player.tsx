...
const AudioPlayer = () => {  
    ...
    return (
        <div className='h-full my-5 px-5 py-10 flex flex-col items-center gap-2 bg-gradient-to-br from-black to-[#7A7A7A] rounded-[40px]'>
            ...
            <span className='py-4 w-full inline-flex flex-row justify-center items-center gap-6'>
                <AddToPlaylistIcon className='m-3 p-2 w-12 h-12 rounded-xl bg-[#7A7A7A] text-white shadow-2xl shadow-black hover:cursor-pointer' />
            ...
            <span className='w-full px-12 my-5'>
                <h1 className='lg:w-full truncate oveflow-hidden font-bold text-center'>Chalo Chalein</h1>
                <h5 className='lg:w-full truncate oveflow-hidden font-normal text-center'>Ritviz ft. Seedhe Maut</h5>
            </span>
        </div>
    );
}
