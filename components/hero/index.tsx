	...
	return (
		<div>
			<div className='w-full mt-20 p-4 pb-0 flex flex-col justify-center items-center gap-8 bg-gradient-to-b from-gray-300 via-gray-900 to-black bg-clip-text animate-enter-div'>
				...
				<form className='w-full mx-3 my-6 flex flex-row justify-center gap-6 font-bold text-white'>
					...
					<button
						...
						onClick={openModal}>
						<p className='w-full text-lg font-bold text-center cursor-pointer'>
							Create
						</p>
					</button>
				</form>
			...
			<HeadlessModal
				...
				<input
					className='w-full mt-4 appearance-none p-4 bg-inherit border-white text-white text-md placeholder-slate-300 rounded-lg focus:outline-none'
					type={'text'}
					placeholder={'Room Name *'}
					onChange={onChangeNewRoomName}
					value={newRoomName}
				/>
				<p className='m-0 pl-2 py-1 text-xs opacity-50'>
					Min of 6 and Max of 15 characters required.
				</p>
			</HeadlessModal>
		</div>
	);
