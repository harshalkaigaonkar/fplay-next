...
import { APIResponse, AuthUserType, ClientToServerEvents, MongooseUserTypes, ServerToClientEvents, SocketClientType, UseSession } from 'types';
...
const Home: NextPage<HomeProps> = () => {
  ...
  const [alertState, setAlertState] = useState<boolean>(router.query.redirect === "not_available" ? true : false);
        ...
        {alertState && (
          <div className='w-full flex justify-center my-2'>
            <section className='flex p-4 w-fit items-center gap-2 bg-black/50 rounded-md'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="white" className="w-6 h-6 hover:text-black/60 cursor-pointer" onClick={() => setAlertState(false)}>
